...
## Alternative Styles
- You can use [no-arg constructors](https://gitlab.cj.dev/training/react-router-hooks-test-driven/tree/no-arg-constructor) instead of a context (service locator)
